...
namespace CodingChallenges.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<Roles> GetRoleByIdAsync(string roleId)
        {
        ...
        public async Task<Roles> GetRoleLoadRelatedAsync(string roleName)
        {
        ...
        public async Task<List<Roles>> GetRolesLoadRelatedAsync(int page, int pageSize)
        {
            IQueryable<Roles> rolesQuery = _context.Roles
                .Include(r => r.Claims)
                .Include(r => r.Users)
                .OrderBy(r => r.Name);
        ...
        public async Task<Tuple<bool, string[]>> CreateRoleAsync(Roles role, IEnumerable<string> claims)
        {
            if (claims == null)
                claims = new string[] { };
        ...
        public async Task<Tuple<bool, string[]>> UpdateRoleAsync(Roles role, IEnumerable<string> claims)
        {
            if (claims != null)
            {
                string[] invalidClaims = claims.Where(c => ApplicationPermissions.GetPermissionByValue(c) == null).ToArray();
        ...
        public async Task<Tuple<bool, string[]>> DeleteRoleAsync(Roles role)
        {
